...
idl -e "gettf_nbs, i_xx_st=$ISTART, i_xx_ed=$IEND, run_name='zf01', inj_mode='phot'" # full run
# idl -e "gettf_nbs, i_xx_st=$ISTART, i_xx_ed=$IEND, run_name='zf001', inj_mode='phot', i_nB_st=6, i_nB_ed=7" # only nBs=1