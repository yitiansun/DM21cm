...
class StepSize250909:
    ...
    def pwave_elec_c_sigma(self, m):
        ...
        log10m = np.log10(m)
        log10c = bezier_curve([[6.5, -23], [10.5, -20], [12, -14.5]], log10m) + 1.85
        return 10 ** log10c
