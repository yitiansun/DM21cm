...
#SBATCH --job-name=pbhhr-a0.999-250909
#SBATCH --array=0-3
...
#--- pwave / pbhhr / pbhacc ---
python inj_script.py --run_name pbhhr-a0.999-250909 --channel pbhhr-a0.999 -i $SLURM_ARRAY_TASK_ID --n_inj_steps 2 --step_mult 1
